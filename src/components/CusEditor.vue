<template>
  <div class="customcomp-editor">
    <toolbar class="editor-toolbar" :editor="editorRef" :defaultConfig="config" />
    <slot />
    <editor
      mode="simple"
...
import type { IDomEditor, IToolbarConfig, IEditorConfig } from '@wangeditor/core'
...
const emits = defineEmits<{
  (e: 'update:modelValue', html: string): void // 自定义事件
